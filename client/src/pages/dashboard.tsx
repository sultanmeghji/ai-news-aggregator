...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    if (storiesData?.stories && storiesData.stories.length === 0 && !isLoading) {
  ...
  const filteredStories = (storiesData?.stories || []).sort((a, b) => {
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-3">
                ...
                <h1 className="text-xl font-semibold text-gray-900">AI Trending Stories v2.0</h1>
              </div>
              {lastUpdated && (
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 flex-1">
                <h3 className="text-sm font-medium text-red-800">
                  API Error - v2.0 Enhanced Diagnostics
                </h3>
                <div className="mt-2 text-sm text-red-700">
                  ...
                  {error && typeof error === 'object' && 'stack' in error && error.stack && (
                    <>
                      ...
                      <div className="bg-red-100 p-2 rounded text-xs font-mono max-h-32 overflow-y-auto">
                        {String(error.stack)}
                      </div>
                    </>
                  )}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-6">
              <div className="text-sm text-gray-500">
                v2.0 - Enhanced AI News Aggregation | Powered by News API & Claude AI
              </div>
